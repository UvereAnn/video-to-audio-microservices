...
- This project was completed as part of a DevOps masterclass/tutorial by **Nasiullha Chaudhari - Cloud Champ**.
- **Disclaimer:** This repository is for educational purposes. All architecture and logic follow the tutorial guidelines provided by the aforementioned creator.